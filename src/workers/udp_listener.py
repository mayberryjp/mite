...
def run_udp_listener():
    ...
    batch_flush_interval = _get_float_setting("udp_batch_flush_interval_seconds", UDP_BATCH_FLUSH_INTERVAL_DEFAULT)
    udp_recv_buffer = _get_int_setting("udp_recv_buffer_bytes", UDP_RECV_BUFFER_DEFAULT, min_value=65536)
